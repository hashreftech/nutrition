define([
    ...
    return Component.extend({
        ...
        setShippingInformation: function () {
            ...
            /*codes start for validating pincode*/
            if ($('.pincode-note').length) {
                $('.pincode-note').remove();
            }
            var shippingAdd = quote.shippingAddress();
            var thisObj = this;
            var linkUrl = url.build('wbcompin/pincode/validate');
            var $pinFlag = 'true';
            if(!(shippingAdd.postcode.length)){
                return false;
            }
            $.ajax({
                url: linkUrl,
                ...
                complete: function(data) {
                    ...
                    if (responseText.response != 'true') {
                        $pinFlag = 'false';
                        $('[name="postcode"]').after('<p class="pincode-note pincode-error">'+responseText.message+'</p>');
                        return false;
                    }else{
